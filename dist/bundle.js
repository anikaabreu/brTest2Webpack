...
/* WEBPACK VAR INJECTION */(function($, Backbone) {var ContainerView = __webpack_require__(10);

var AppView = __webpack_require__(11);
...
var App = {
  ...
  init: function init() {
    ...
    $('#container').on('click', 'a:not([data-bypass],[target])', function (evt) {
      console.log('trappeda  click');
      var href = $(this).attr('href'),
          protocol = this.protocol + '//'; // For <a href="#"> links, we always want to preventDefault to avoid having to do
      ...
      if (href && href.slice(0, protocol.length) !== protocol && href.indexOf('#') !== 0 && href.indexOf('mailto:') !== 0 && href.indexOf('tel:') !== 0) {
        // Stop the default event to ensure the link will not cause a page
        // refresh.
        evt.stopPropagation();
        evt.preventDefault(); // `Backbone.history.navigate` is sufficient for all Routers and will
...
/* WEBPACK VAR INJECTION */(function(Backbone, $) {var ContainerView = Backbone.View.extend({
  ...
  showAlert: function showAlert(html, type) {
    this.$('.alert').html(html).removeClass('alert-success alert-info alert-warning alert-danger').addClass('alert-' + type).show();
  }
}); // ContainerView
...
/* WEBPACK VAR INJECTION */(function(Backbone) {var template = __webpack_require__(12);
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- HTML Template for Home page of App -->\n\n\n<div class=\"container\">\ntest test\n\n</div>\n";
},"useData":true});
